...
open class ChartViewBase: NSUIView, ChartDataProvider, AnimatorDelegate
{
    ...
    @objc open var noDataFont: NSUIFont! = NSUIFont(name: "Quicksand-Medium", size: 14.0)
    
    /// color of the no data text
    @objc open var noDataTextColor: NSUIColor = NSUIColor.white.withAlphaComponent(0.5)
